          ...
          allOf: [
            {
              type: "object",
              properties: {
                title: { type: "string", nullable: true, maxLength: 1000 },
              ...
              oneOf: [
                {
                  ...
                  properties: {
                    ...
                    precrawledArchiveId: { type: "string" },
                  },
                  required: ["type", "url"],
                },
                {
                ...
                },
                {
                  ...
                  properties: {
                    ...
                    assetType: { type: "string", enum: ["image", "pdf"] },
                    assetId: { type: "string" },
                    fileName: { type: "string" },
                    sourceUrl: { type: "string" },
                  },
                  required: ["type", "assetType", "assetId"],
                },
              ],
            },
          ],
              ...
              tags: {
                ...
                items: {
                  ...
                  properties: {
                    id: { type: "string" },
                    name: { type: "string" },
                    attachedBy: { type: "string", enum: ["ai", "human"] },
                  },
                  required: ["id", "name", "attachedBy"],
                },
              },
              content: {
                oneOf: [
                  ...
                  {
                    type: "object",
                    properties: { type: { type: "string", enum: ["unknown"] } },
                    required: ["type"],
                  },
                ],
              },
